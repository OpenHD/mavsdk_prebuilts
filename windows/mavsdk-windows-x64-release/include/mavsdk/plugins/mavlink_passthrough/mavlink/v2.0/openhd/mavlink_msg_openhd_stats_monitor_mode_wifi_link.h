...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_LEN 58
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_MIN_LEN 58
#define MAVLINK_MSG_ID_1212_LEN 58
#define MAVLINK_MSG_ID_1212_MIN_LEN 58

#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_CRC 150
#define MAVLINK_MSG_ID_1212_CRC 150
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_LINK { \
    ...
    11, \
    {  { "curr_tx_pps", NULL, MAVLINK_TYPE_INT32_T, 0, 32, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_tx_pps) }, \
         { "curr_rx_pps", NULL, MAVLINK_TYPE_INT32_T, 0, 36, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_rx_pps) }, \
         { "curr_tx_bps", NULL, MAVLINK_TYPE_INT32_T, 0, 40, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_tx_bps) }, \
         { "curr_rx_bps", NULL, MAVLINK_TYPE_INT32_T, 0, 44, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_rx_bps) }, \
         { "curr_rx_packet_loss_perc", NULL, MAVLINK_TYPE_INT16_T, 0, 56, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, curr_rx_packet_loss_perc) }, \
         ...
         { "unused0", NULL, MAVLINK_TYPE_INT32_T, 0, 48, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused0) }, \
         { "unused1", NULL, MAVLINK_TYPE_INT32_T, 0, 52, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused1) }, \
         { "unused2", NULL, MAVLINK_TYPE_UINT64_T, 0, 16, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused2) }, \
         { "unused3", NULL, MAVLINK_TYPE_UINT64_T, 0, 24, offsetof(mavlink_openhd_stats_monitor_mode_wifi_link_t, unused3) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_LINK { \
...
static inline uint16_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               int32_t curr_tx_pps, int32_t curr_rx_pps, int32_t curr_tx_bps, int32_t curr_rx_bps, int16_t curr_rx_packet_loss_perc, uint64_t count_tx_inj_error_hint, uint64_t count_tx_dropped_packets, int32_t unused0, int32_t unused1, uint64_t unused2, uint64_t unused3)
{
    ...
    _mav_put_uint64_t(buf, 16, unused2);
    _mav_put_uint64_t(buf, 24, unused3);
    _mav_put_int32_t(buf, 32, curr_tx_pps);
    _mav_put_int32_t(buf, 36, curr_rx_pps);
    _mav_put_int32_t(buf, 40, curr_tx_bps);
    _mav_put_int32_t(buf, 44, curr_rx_bps);
    _mav_put_int32_t(buf, 48, unused0);
    _mav_put_int32_t(buf, 52, unused1);
    _mav_put_int16_t(buf, 56, curr_rx_packet_loss_perc);
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_link_send(mavlink_channel_t chan, int32_t curr_tx_pps, int32_t curr_rx_pps, int32_t curr_tx_bps, int32_t curr_rx_bps, int16_t curr_rx_packet_loss_perc, uint64_t count_tx_inj_error_hint, uint64_t count_tx_dropped_packets, int32_t unused0, int32_t unused1, uint64_t unused2, uint64_t unused3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_LINK_LEN];
    _mav_put_uint64_t(buf, 0, count_tx_inj_error_hint);
 ...
 */
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_link_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t curr_tx_pps, int32_t curr_rx_pps, int32_t curr_tx_bps, int32_t curr_rx_bps, int16_t curr_rx_packet_loss_perc, uint64_t count_tx_inj_error_hint, uint64_t count_tx_dropped_packets, int32_t unused0, int32_t unused1, uint64_t unused2, uint64_t unused3)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline int32_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_get_curr_tx_pps(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_get_curr_rx_pps(const mavlink_message_t* msg)
{
 ...
 * @return  unused2
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_get_unused2(const mavlink_message_t* msg)
{
 ...
 * @return  unused3
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_link_get_unused3(const mavlink_message_t* msg)
{
