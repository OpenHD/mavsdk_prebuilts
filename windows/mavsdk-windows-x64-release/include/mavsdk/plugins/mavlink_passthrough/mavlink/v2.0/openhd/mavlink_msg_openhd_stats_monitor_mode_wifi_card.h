...
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_LEN 34
#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_MIN_LEN 34
#define MAVLINK_MSG_ID_1211_LEN 34
#define MAVLINK_MSG_ID_1211_MIN_LEN 34

#define MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_CRC 108
#define MAVLINK_MSG_ID_1211_CRC 108
...
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_CARD { \
    ...
    6, \
    {  { "card_index", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, card_index) }, \
         { "rx_rssi", NULL, MAVLINK_TYPE_INT8_T, 0, 33, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, rx_rssi) }, \
         ...
         { "dummy0", NULL, MAVLINK_TYPE_UINT64_T, 0, 16, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy0) }, \
         { "dummy1", NULL, MAVLINK_TYPE_UINT64_T, 0, 24, offsetof(mavlink_openhd_stats_monitor_mode_wifi_card_t, dummy1) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_OPENHD_STATS_MONITOR_MODE_WIFI_CARD { \
...
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_send(mavlink_channel_t chan, uint8_t card_index, int8_t rx_rssi, uint64_t count_p_received, uint64_t count_p_injected, uint64_t dummy0, uint64_t dummy1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPENHD_STATS_MONITOR_MODE_WIFI_CARD_LEN];
    _mav_put_uint64_t(buf, 0, count_p_received);
 ...
 */
static inline void mavlink_msg_openhd_stats_monitor_mode_wifi_card_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t card_index, int8_t rx_rssi, uint64_t count_p_received, uint64_t count_p_injected, uint64_t dummy0, uint64_t dummy1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return  dummy0
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_dummy0(const mavlink_message_t* msg)
{
 ...
 * @return  dummy1
 */
static inline uint64_t mavlink_msg_openhd_stats_monitor_mode_wifi_card_get_dummy1(const mavlink_message_t* msg)
{
